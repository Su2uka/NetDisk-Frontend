...
Item {
    ...
    // === 样式属性 ===
    property color normalColor: Qt.rgba(248/255,248/255,248/255,1)
    property color hoverColor: Qt.rgba(243/255,243/255,243/255,1)
    property color focusColor: Qt.rgba(255/255,255/255,255/255,1)
    property color borderColor: "#dfdfdf"
        ...
        RowLayout {
            ...
            Item {
                ...
                FluIcon {
                    ...
                    iconColor: input.activeFocus ? FluTheme.primaryColor : Qt.rgba(96/255,96/255,96/255,1)
                }
            }
